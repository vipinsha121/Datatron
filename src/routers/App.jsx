...
import { PrivacyPolicy, TermsService } from "../pages/Resources";
...
import { Company, Career, Press, Testimonial } from "../pages/Company";
    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <Route
            exact
            path="/platform/model-governance"
          ...
          <Route exact path="/solution/whitepapers" component={WhitePapers} />
          <Route exact path="/solution/usecase" component={UseCase} />
          <Route
            exact
            path="/solution/industry/telecom"
            component={Telecommunication}
          />
          <Route
            exact
            path="/solution/industry/financial"
            component={Financial}
          />
          <Route
            exact
            path="/solution/industry/logistics"
            component={Logistics}
          />
          <Route
            exact
            path="/solution/usecase/dynamic-pricing"
            component={DynamicPricing}
          />
          <Route
            exact
            path="/solution/usecase/demand-forecast"
            component={DemandForecast}
          />
          <Route
            exact
            path="/solution/usecase/bond-market"
            component={BondMarket}
          />
          ...
          <Route exact path="/resource/webinarevent" component={WebinarEvent} />
          <Route
            exact
            path="/resource/privacy-policy"
