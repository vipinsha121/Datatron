  ...
  return (
    <div className="privacy_policy-container newResource">
      <div className="privacy_policy-wrapper">
        ...
        <ul className="privacy_policy-list_wrapper">
          <li>
        ...
        <p className="privacy_policy-title">
        ...
        <ul className="privacy_policy-list_wrapper">
          ...
          <li>
            ...
            Party Vendors”) to further the purpose for which you provided such information to us. For example, we may share your information with Elastic Email, for the purpose of sending emails.
            <br />
            <b>We urge you to read the privacy practices of all of our Third Party Vendors before submitting any personally identifiable information through the Service.</b>
          </li>
          <li>
          ...
          <li>
            ...
            or change of control of Datatron or the division responsible for the services with which your personally identifiable information is associated.
          </li>
          <li>
            We may share your personally identifiable information with an affiliate of Datatron who is in the same corporate family as us as long as their privacy practices are substantially similar to ours.
          </li>
        </ul>
        ...
        <p className="privacy_policy-paragraph">
          The Analytics Service collects information anonymously. They report website trends without identifying individual visitors. You can opt out of the Analytics Service without affecting how you visit our site. For more information on opting out of being tracked by Google Analytics across all websites you use, visit <a href="https://tools.google.com/dlpage/gaoptout">https://tools.google.com/dlpage/gaoptout</a>.
        </p>
        ...
        <p className="privacy_policy-paragraph">
          This Privacy Policy and our legal obligations hereunder are subject to the laws of the State of California regardless of your location.  You hereby consent to the exclusive jurisdiction of and venue in the courts located in the State of California, County of Santa Clara, in all disputes arising out of or relating to the Services.
        </p>
        ...
        <p className="privacy_policy-paragraph">
          For questions or concerns relating to privacy, we can be contacted at team@datatron.io
        </p>
        ...
        <p className="privacy_policy-paragraph">
          This Privacy Policy was last updated on 11/26/2019.
        </p>
      </div>
    </div>
  );
